...
Key Features
Dynamic Labeling: Automatically generates standardized entry labels (e.g., E-9401) by merging numeric IDs with specific series prefixes.

Coordinate Transformation: Translates Row, Column, and Replication indices into exact meter-based X/Y coordinates for a 38m x 12m field.
...
Replication Shading: Uses ggplot2 to visually distinguish between experimental replications, assisting in alpha lattice design verification.
...
How to Use
Prepare Data: Ensure your dataset (e.g., Research_data) includes the following columns: Entry, Row, Column, and Rep.

Set Dimensions: The script is currently calibrated for a 38x12m field. Adjust the X_phys and Y_phys logic if your field dimensions differ.

Execute: Run the script in RStudio to generate the interactive and static field maps.
